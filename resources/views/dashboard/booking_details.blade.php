    ...
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        <div class="flex flex-col gap-8">
          <div class="flex flex-col gap-3 px-4 ">
            ...
            @else
                <div class="success-badge w-fit border border-[#FFA500] p-[4px_8px] rounded-lg bg-[#FFD700] flex items-center justify-center" style="background-color: #FFD700; border-color: #FFA500;">
                    <span class="text-xs leading-[22px] tracking-035 text-[#FF4500]" style="color: black;">Sedang di validasi oleh admin</span>
                </div>
            @endif
          ...
          <div class="flex flex-col gap-3 px-4 ">
            <a href="https://wa.me/6281284964533" class="p-[16px_24px] rounded-xl bg-blue w-full text-white text-center flex items-center justify-center gap-3  hover:bg-[#06C755] transition-all duration-300">
              <div class="w-6 h-6">
